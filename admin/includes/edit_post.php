...
<head>
    ...
    <script type="text/javascript" src='https://cdn.tiny.cloud/1/oecupyfjndw4v6plh3cidjvbv023toe93q1uams4u2pyzs0b/tinymce/6/tinymce.min.js' referrerpolicy="origin">
    </script>
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class=" form-group">
            ...
            <textarea type="text" class="form-control" name="create_post" id="myTextarea" cols="30" rows="100"><?php echo $post_content; ?></textarea>
        </div>
        <div class=" form-group">
